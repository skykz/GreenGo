...
class SingleCategiryStoreHomeScreen extends StatefulWidget {
  final bool isStore;
  const SingleCategiryStoreHomeScreen({Key key, this.isStore = false})
      : super(key: key);
...
class _SingleHomeScreenState extends State<SingleCategiryStoreHomeScreen> {
